...
;手动添加的代理 ###
ruleset=🚀 手动选择,clash-classic:https://testingcf.jsdelivr.net/gh/love768952693/ssr-kcp@refs/heads/main/config/clash/ProxyLite.yaml,28800
ruleset=📄 日服刮削,clash-classic:https://testingcf.jsdelivr.net/gh/blackmatrix7/ios_rule_script@master/rule/Clash/DMM/DMM.yaml,28800
ruleset=📄 日服刮削,clash-classic:https://testingcf.jsdelivr.net/gh/love768952693/ssr-kcp@refs/heads/main/config/clash/Jp_Proxy.yaml,28800
;手动添加结束 ###
...
custom_proxy_group=📄 日服刮削`select`[]🎯 全球直连`[]🇯🇵 日本节点`[]🚀 手动选择`[]♻️ 自动选择
...
custom_proxy_group=🐟 漏网之鱼`select`[]🇭🇰 香港节点`[]🇺🇸 美国节点`[]🇯🇵 日本节点`[]🇸🇬 新加坡节点`[]🇼🇸 台湾节点`[]🇰🇷 韩国节点`[]🇨🇦 加拿大节点`[]🇬🇧 英国节点`[]🇫🇷 法国节点`[]🇩🇪 德国节点`[]🇳🇱 荷兰节点`[]🇹🇷 土耳其节点`[]🏠 家宽节点`[]🌐 其他地区`[]🚀 手动选择`[]♻️ 自动选择`[]🎯 全球直连`.*
